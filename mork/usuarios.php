...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td>    
                <a href="editUser.php?id=<?php echo $u['id'];?>">Editar</a>
                |
                <a href="deleteuser.php?id=<?php echo $u['id'];?>">Excluir</a>
            </td>
        </tr>
        <?php endforeach ?>
    </table>
            <div class="card-dashboard">
                 ...
                 <a href="createUser.php"><input class="button" type="button" value="Cadastrar usuário"></a>
            </div>
</body>
</html>
