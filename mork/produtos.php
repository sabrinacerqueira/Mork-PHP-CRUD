...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo $s['preco'];?></td>
            <td>    
                <a href="editservico.php?id=<?php echo $s['id'];?>">Editar</a>
                |
                <a href="deleteservico.php?id=<?php echo $s['id'];?>">Excluir</a>
            </td>
        </tr>
        <?php endforeach ?>
    </table><br>
       ...
       <div class="produtos_carrinho">
        <section id="produtos">
            ...
            <div class="card-dashboard">
                 <a href="createservicos.php"><input class="button" type="button" value="Novo Produto"></a>
            </div>
